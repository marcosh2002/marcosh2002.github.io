<?php
/**
 * Emergency Header.php Updater
 * Upload this file to your server root, run it once, then delete it
 * 
 * USAGE:
 * 1. Upload this file to: royaldesicrew.com/upload-header.php
 * 2. Visit: royaldesicrew.com/upload-header.php?confirm=yes
 * 3. Check your website - CSS should now display
 * 4. DELETE this file from your server
 */

// Verify confirmation parameter (safety check)
if (!isset($_GET['confirm']) || $_GET['confirm'] !== 'yes') {
    die('<h1>CSS Upload Script</h1><p>This will update your header.php with hardcoded CSS.</p><p><strong>WARNING:</strong> This file should be deleted after running!</p><p><a href="?confirm=yes">Click here to proceed</a></p>');
}
...
// The complete hardcoded header content with inline CSS
...
<section class="hero">
    <div class="hero-bg-carousel" id="heroBgCarousel"></div>
    <div class="hero-overlay"></div>
    
    <div class="hero-content">
        <div class="experience-badge">
            <i class="fas fa-crown exp-icon"></i>
            <span class="exp-text">Premium Wedding & Events</span>
        </div>
        
        <h1 class="hero-title">
            Your <span class="gold">Royal</span> Affair
        </h1>
        
        <p class="hero-subtitle">
            Luxury event planning & photography for unforgettable moments
        </p>

        <div class="hero-buttons">
            <button class="btn btn-primary" onclick="document.getElementById('bookingModal').classList.add('show')">
                <i class="fas fa-calendar-alt"></i> Book Now
            </button>
            <button class="btn btn-secondary" onclick="document.getElementById('galleryModal').classList.add('show')">
        ...
        <div class="hero-trust-section">
            <div class="trust-stats">
                <div class="stat-item">
                    ...
                    <span class="stat-text">500+ Weddings</span>
                </div>
                <span class="stat-divider">|</span>
                <div class="stat-item">
                    <span class="stat-icon">⭐</span>
                    <span class="stat-text">4.9/5 Rating</span>
                </div>
                <span class="stat-divider">|</span>
                <div class="stat-item">
                    <span class="stat-icon">🏆</span>
                    <span class="stat-text">Award Winning</span>
                </div>
            </div>
        </div>
    </div>
...
if (file_put_contents($header_file, $new_header_content) !== false) {
    echo '<h2 style="color: green;">✓ SUCCESS!</h2>';
    echo '<p>header.php has been updated with hardcoded CSS.</p>';
    ...
    echo '<li>Your website should now display with full styling!</li>';
    echo '</ol>';
    ...
    echo 'Go to cPanel → File Manager → Delete <code>upload-header.php</code>';
    echo '</p>';
} else {
    echo '<p style="color: red;"><strong>ERROR:</strong> Could not write to header.php</p>';
    echo '<p>Make sure the file permissions allow writing (644 or higher)</p>';
    echo '<p>Contact support or try FTP upload instead</p>';
}
